...
const FoodDetailScreen = ({ route }) => {
    ...
    const toggleFavorite = async () => {
        if (isFavorite) {
            ...
            api.favorites.remove(foodItem.id).catch(() => {});
        } else {
            ...
            api.favorites.add(foodItem.id).catch(() => {});
        }
    };
    ...
    const renderImageItem = ({ item }) => <CarouselImage item={item} />;
                    ...
                    <View style={styles.ratingSection}>
                        ...
                        <View style={styles.statsContainer}>
                            ...
                            <View style={styles.statItem}>
                                ...
                                />
                                <Text style={styles.statText}>{foodItem.calories ? `${foodItem.calories} cal` : 'N/D'}</Text>
                            </View>
